...
共同留下痕迹：`MARK` 在邻近可走格写下地名；燧石+浮木可生篝火（夜间睡觉更好、夜间视野略增，暴雨会浇灭）；`FOLLOW` 贴邻格跟随视野内的人；`MEET` 把会合点写成全图可见的约定。东岸有一件唯一的潮汐神像。五个人的长期目标改成互补（起名 / 通报 / 记故事 / 生火 / 照看）。

## v2.11

决策回路硬化：走路中不再因饥饿反复改终点；只有包里有食物或黄昏/夜间能睡时才打断去吃/睡。计划按匹配推进并写回当前目标；观察改为区域/地标/活人/尸体/食物；非食物 `USE` 明确失败。

## v2.10

开局口粮、迷雾边界作为 MOVE_TO 候选、对人操作须在视野内、一次 `PICK_UP` 收光可见食物。

## v2.9

黎明结算健康；连续缺觉或断食可病死；死人停 LLM，尸体留场。

## v2.8

精力与饱腹：当前值会掉，连续熬夜压低精力上限，连续不吃压低饱腹上限（并略伤精力上限）。睡觉回精力（饿着睡打折），吃野果顶饿并稍补精力、不能代替睡觉。地上会刷新野莓/野坚果/海葡萄；每人食物最多带 3 个。角色头顶有精力条（白刻度是当前上限），细条是饱腹。
